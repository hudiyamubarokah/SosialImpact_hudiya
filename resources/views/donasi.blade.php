                    ...
                    <div class="row">
                        <div class="col-xl-6 col-md-12 col-lg-8">
                            <div class="short_contact_list">
                                <ul>
                                    <li><a href="#"> <i class="fa fa-phone"></i> +62 822 1992-4336</a></li>
                                    <li><a href="#"> <i class="fa fa-envelope"></i>hudiyamubarokah@gmail.com</a></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <div class="col-xl-3 col-lg-3">
                            <div class="logo">
                                <a href="index.html">
                                    <h1 class="text-white">SosialImpact</h1>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="main-menu">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a href="#">Reports <i class="ti-angle-down"></i></a>
                                        </li>
                                        <li><a href="#">Donasi <i class="ti-angle-down"></i></a>
                                        </li>
